...
komodo_cli=/home/sylberg/komodo/src/komodo-cli

# all you need is to insert your pubkey here in lock script format: 21{YOUR_33_BYTES_HEX_PUBKEY}AC
NN_PUBKEY=2103f5a12b153f4d29cd763105a5771042d9d8eb6f59c08c403e16acaf675d774a7bac
...
function do_autosplit() {
    ...
    #utxo=$($komodo_cli $asset listunspent | grep .0001 | wc -l) # this is old way p2pk utxo determine (deprecated)
...
declare -a kmd_coins=(BEER PIZZA TXSCLCC)
for i in "${kmd_coins[@]}"
do
    do_autosplit $i
done
